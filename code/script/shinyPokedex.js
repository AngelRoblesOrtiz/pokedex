...
function gen(pokemon) {
    return `
            <div class = 'pokemon'>
                <div class = 'pkmn-grid'><a href = '../../searchPokemon.html?pokemon=${pokemon.name}'><img src = '${pokemon.sprite}' class = 'pkmn-grid-img'></a></div>
                <div class = 'pkmn-grid-idx'><p class = 'pkmn-grid-idx-txt'>#${pokemon.index}</p></div>
                <div class = 'pkmn-grid-name'><a href = './searchPokemon.html?pokemon=${pokemon.name}' class = 'pkmn-grid-name-txt'>${capitalizeEveryFirstLetter(pokemon.name)}</a></div>
...
async function shinyPokedex() {
    const pkmnContainer1 = document.querySelector('.shiny-pkmn-down-1'); 
    let pageLines1 = ''; 
    let currentLine1 = ''; 
    for (let i = 1; i <= 151; i++) { 
    ...
    const pkmnContainer2 = document.querySelector('.shiny-pkmn-down-2'); 
    let pageLines2 = ''; 
    let currentLine2 = ''; 
    ...
    const pkmnContainer3 = document.querySelector('.shiny-pkmn-down-3'); 
    let pageLines3 = ''; 
    let currentLine3 = ''; 
    ...
    const pkmnContainer4 = document.querySelector('.shiny-pkmn-down-4'); 
    let pageLines4 = ''; 
    let currentLine4 = ''; 
    ...
    const pkmnContainer5 = document.querySelector('.shiny-pkmn-down-5'); 
    let pageLines5 = ''; 
    let currentLine5 = ''; 
    ...
    const pkmnContainer6 = document.querySelector('.shiny-pkmn-down-6'); 
    let pageLines6 = ''; 
    let currentLine6 = ''; 
    ...
    const pkmnContainer7 = document.querySelector('.shiny-pkmn-down-7'); 
    let pageLines7 = ''; 
    let currentLine7 = ''; 
    ...
    const pkmnContainer8 = document.querySelector('.shiny-pkmn-down-8'); 
    let pageLines8 = ''; 
    let currentLine8 = ''; 
    ...
    const pkmnContainer9 = document.querySelector('.shiny-pkmn-down-9'); 
    let pageLines9 = ''; 
    let currentLine9 = ''; 
